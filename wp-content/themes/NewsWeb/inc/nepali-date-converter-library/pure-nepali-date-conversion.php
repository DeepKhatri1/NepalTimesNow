 ...
 */
if ( !function_exists( 'dtn_convert_to_nepali' ) ) {
 ...
 */
if ( !function_exists( 'dtn_get_nepali_number' ) ) {
 ...
 */
if ( !function_exists( 'dtn_get_mahina' ) ) {
 ...
 */
if ( !function_exists( 'dtn_get_baar' ) ) {
 ...
 */
if ( !function_exists( 'array_trim_nil' ) ) {
