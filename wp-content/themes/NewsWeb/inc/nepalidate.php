...
<?php
	class Nepali_Calendar
	{
		...
		public $_nep_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'nmonth' => '', 'num_day' => '');
		public $debug_info = "";
		/**
		 * Return day
		 *
		 ...
		 * @return bool
		 */
		public function _is_in_range_eng($yy, $mm, $dd)
		{
			if ($yy < 1944 || $yy > 2033)
			{
		...
		public function eng_to_nep($yy, $mm, $dd)
		{
			...
			else
			{
				...
				$nepaliNumber = array('१', '२', '३', '४', '५', '६', '७', '८', '९', '०');


				$nepaliday = str_replace($englishNumber, $nepaliNumber, $total_nDays);
				$nepaliyear = str_replace($englishNumber, $nepaliNumber, $y);
				$nepalidaynumber = str_replace($englishNumber, $nepaliNumber, $day);
				$nepalimonth = $this->_get_nepali_month($m);
				$nepaliweek = $this->_get_day_of_week($day);
				$nepalimonthnumber = str_replace($englishNumber, $nepaliNumber, $m);

				$nepalidate = $nepaliyear .' '. $nepalimonth .' '. $nepaliday .' '. $nepaliweek;
				return $nepalidate;
			}
		}
	}
